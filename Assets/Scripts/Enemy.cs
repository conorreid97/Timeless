...
public class Enemy : Character {
    ...
    // if the players sword collider or bullet hit the enemy then start take damage function
    ...
    // this is the take damage function where the enemy health bar is updated and trigges the animation
